  ...
  return (
    ...
    >
      {followUpQuestions?.map((question) => (
        <div
          key={question}
          className="text-secondary-foreground bg-secondary hover:bg-accent rounded-xl p-4 text-sm shadow-md transition-all duration-300 select-none hover:cursor-pointer"
          onClick={() => {
